...
@section('content')
    ...
    <p>We received a request to reset your password for your <strong>Wollo University Lost & Found</strong> account. Use the one-time code below to proceed with resetting your password:</p>
